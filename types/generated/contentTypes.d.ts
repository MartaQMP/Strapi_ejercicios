...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Class_details: Schema.Attribute.Component<
      'additional-details.class-details',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Event_details: Schema.Attribute.Component<
      'additional-details.events-details',
      false
    >;
    locale: Schema.Attribute.String;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    Studio_material: Schema.Attribute.Media<
